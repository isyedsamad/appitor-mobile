...
import { Eye, EyeOff, LogOut, Moon, Repeat, Smartphone, Sun } from 'lucide-react-native';
...
export default function StudentProfilePage() {
  ...
  const { schoolUser, classData, isLoaded, handleSignOut, handleSwitch } = useAuth();
      ...
      <ScrollView>
        <View className="px-5 pb-10">
          <View
            ...
            <View className="flex-1">
              ...
              <AppText size="min" muted semibold>
                {capitalizeWords(schoolUser.role)} • {schoolUser.appId}
              </AppText>
          ...
          <InfoCard title="Academic Information">
            ...
            <InfoRow
              label="Roll No"
              value={schoolUser.rollNo ? schoolUser.rollNo.toString().padStart(2, '0') : '-'}
            />
          </InfoCard>
