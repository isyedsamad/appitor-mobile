...
export default function EmployeeHomeworkPage() {
  ...
  const selectedSectionSearch = selectedClassSearch?.sections?.find((s: any) => s.id === sectionId);
  ...
  async function saveHomework() {
    ...
    if (!content.trim()) {
      Toast.show({
        type: 'error',
        text1: 'Homework Missing',
        text2: 'Please enter homework to continue!',
      });
      return;
    }
    ...
    if (!timetableActive && (!period || !classId || !subjectId || !sectionId)) {
      Toast.show({
        ...
        text2: 'Please select all the required fields!',
      });
      return;
    }
    setLoading(true);
    ...
    <>
      <Screen scroll={false}>
        ...
        <ScrollView>
              ...
              <View className="flex-row items-center justify-center gap-3">
                ...
                <View className="flex-1">
                  ...
                  <TouchableOpacity
                    ...
                    <AppText semibold>
                      {sectionIdSearch
                        ? getSection(classIdSearch, sectionIdSearch)
                        : 'Select section'}
                    </AppText>
                    <AppText muted>▼</AppText>
                  </TouchableOpacity>
          ...
          <Modal
            visible={showClassPickerSearch}
            statusBarTranslucent
            transparent
            animationType="slide"
            onRequestClose={() => setShowClassPickerSearch(false)}>
          ...
          <Modal
            visible={showSectionPickerSearch}
            statusBarTranslucent
            transparent
            animationType="slide"
                    ...
                    <View
                      ...
                      <View
                        ...
                        <AppText size="min" muted semibold>
                          {capitalizeWords(
                            getTeacherName(tab == 'all' ? item.teacherId : schoolUser.uid)
                          )}
                        </AppText>
                      </View>
                    </View>
            ...
            <View className="flex-1 justify-end bg-black/60">
              <View className="rounded-t-3xl px-8 pt-6" style={{ backgroundColor: colors.bgCard }}>
                ...
                <ScrollView
                  ...
                  <View className="mb-3" style={{ height: 1, backgroundColor: colors.border }} />
                  {timetableActive ? (
                    <>
                      <View className="mb-3">
                      ...
                      <View className="gap-3">
                        {timetableSlots.length === 0 && (
                          <View
                            ...
                            <AppText muted>No timetable found for today</AppText>
                          </View>
                        )}
                      ...
                      <View className="gap-3">
                        ...
                        <View>
                          ...
                          <TouchableOpacity
                            ...
                            className="mt-1 flex-row items-center justify-between rounded-xl border px-4 py-3"
                            style={{ backgroundColor: colors.bg, borderColor: colors.border }}>
                            <AppText semibold>{period ? 'P' + period : 'Select Period'}</AppText>
                            <AppText muted>▼</AppText>
                          </TouchableOpacity>
                        </View>
                        <View>
